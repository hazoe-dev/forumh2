    ...
    <div class="container">
        ...
        <div class="content w-100">
            ...
            <input name="id" type="hidden" value="${id }">
                <h4>Tiêu đề</h4>
                <input name = "title" class="w-100 form-control" type="text" required="required" value="Re: ${title}">
                <h4>Nội dung</h4>
                <textarea name = "content" class="w-100 form-control" name="content-reply" required="required" cols="30" rows="10"></textarea>
